		...
		<div className="slideshow">
			<figure>
				...
				<figcaption>
					...
					<div className="row open-sans-font">
						...
						<div className="col-12 col-sm-6 mb-2">
							...
							<span className="ft-wt-600 uppercase">lillup</span>
						</div>
						{/* End .col */}
						...
						<div className="col-12 col-sm-6 mb-2">
							...
							<span className="ft-wt-600 uppercase">REACT, WEB3, SOLIDITY, BLOCKCHAIN</span>
						</div>
						{/* End .col */}
						...
						<div className="col-12 col-sm-6 mb-2">
							...
							<span className="ft-wt-600 uppercase">
								<a href="https://lillup.com" target="_blank" rel="noreferrer">
									lillup.com
								</a>
							</span>
						</div>
				...
				<Slider {...settings}>
					...
					<div className="slide_item">
						<img src="img/projects/lillup2.PNG" alt="lillup" />
					</div>
					<div className="slide_item">
						<img src="img/projects/lillup3.PNG" alt="lillup" />
					</div>
				</Slider>
